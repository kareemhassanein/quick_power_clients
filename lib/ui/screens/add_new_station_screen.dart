...
class _AddNewStationScreenState extends State<AddNewStationScreen> {
  ...
  void initState() {
    ...
    if(widget.station!=null){
      ...
      latLng = LatLng(double.parse(widget.station!.lat!), double.parse(widget.station!.lon!));
      _updatePlaceMark();
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                onTap: (){
                  navigateToScreen(context, MapPickLocationScreen(latLng: latLng,)).then((value) async {
                    if(value!=null) {
                      latLng = value;
                      _updatePlaceMark();
                    }
              ...
              Center(
                child: TextButton(
                  ...
                  child: Text(
                    'Submit${widget.station!=null ? ' Edit':''}',
                    style: GoogleFonts.poppins(
                      fontSize: 15.0.sp,
                      color: Colors.white,
                      fontWeight: FontWeight.w500,
